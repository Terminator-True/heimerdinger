"""Coaching service: classify, retrieve, build prompt, call the LLM.

Extracted verbatim from ``scripts/ask_coach.py`` (Work Unit 4 of
webapp-v2-migration). The script remains as a thin CLI wrapper over
...
class CoachingService:
    ...
    def ask_coach(self,
        ...
        resp = self.client.generate(prompt=prompt, model=model)
        ...
        try:
            ...
            logger.info("Saved prompt+response via file output port")
        except Exception:
