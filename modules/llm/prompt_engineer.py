...
class PromptEngineer:
    ...
    def build_prompt(self, player_report: Dict, role: str = "coach", meta: Optional[Dict] = None) -> str:
        ...
        """
        name = player_report.get("name") or player_report.get("player_name") or "Player"
        summary = player_report.get("summary") or player_report.get("notes") or str(player_report)
